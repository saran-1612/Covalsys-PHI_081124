...
public class CustomBatchScanAdapter extends RecyclerView.Adapter<BaseViewHolder> {

    private List<DeliveryScanLine> mModel;
    private Context mContext;
    private Callback mCallback;

    public CustomBatchScanAdapter(ArrayList<DeliveryScanLine> mInvoiceModel, Context mContext) {
    ...
    public List<DeliveryScanLine> getList() {
        return mModel;
    }

    public void addData(List<DeliveryScanLine> list) {
        this.mModel = list;
    }
    ...
    public class InvoiceViewHolder extends BaseViewHolder {
        ...
        public void onBind(int position) {
            if (position == 0) {
                ...
                DeliveryScanLine model = mModel.get(position-1);
